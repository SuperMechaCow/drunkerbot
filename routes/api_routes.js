...
expressRouter.get('/bot', function(req, res) {
...
expressRouter.get('/guild', function(req, res) {
	res.set('Content-Type', 'application/json');
...
expressRouter.get('/guild/:guildDID/users', function(req, res) {
	res.set('Content-Type', 'application/json');
...
expressRouter.get('/roll', function(req, res) {
	res.set('Content-Type', 'application/json');
	res.send('{\"result\":' + (Math.round(Math.random() * (20 - 1) + 1)) + '}');
});

expressRouter.get('/ping', function(req, res) {
	res.set('Content-Type', 'application/json');
...
expressRouter.get('/guild/:guildDID/status/', function(req, res) {
	res.set('Content-Type', 'application/json');
...
expressRouter.get('/guild/:guildDID/whois/:userDID', function(req, res) {
	res.set('Content-Type', 'application/json');
